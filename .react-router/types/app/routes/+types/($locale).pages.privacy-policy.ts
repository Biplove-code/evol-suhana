...
type Module = typeof import("../($locale).pages.privacy-policy.js")

type Info = GetInfo<{
  file: "routes/($locale).pages.privacy-policy.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../($locale).pages.privacy-policy.js");
}];
