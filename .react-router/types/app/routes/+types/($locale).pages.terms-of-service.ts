...
type Module = typeof import("../($locale).pages.terms-of-service.js")

type Info = GetInfo<{
  file: "routes/($locale).pages.terms-of-service.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  id: "routes/($locale)";
  module: typeof import("../($locale).js");
}, {
  id: "routes/($locale).pages.terms-of-service";
  module: typeof import("../($locale).pages.terms-of-service.js");
}];
