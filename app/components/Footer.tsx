...
import modelImage from '~/assets/model-vibe.jpg.jfif';
          ...
          <footer className="footer">
            <div className="footer-inner">
              <div className="footer-top">
                  ...
                  <div className="footer-brand-section">
                    <div className="footer-brand">
                      ...
                      <div className="footer-social">
                        <a href="https://instagram.com/evol" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                        ...
                        <a href="https://facebook.com/evol" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                          </svg>
                        </a>
                        <a href="https://twitter.com/evol" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path>
                          </svg>
                        </a>
                        <a href="https://pinterest.com/evol" target="_blank" rel="noopener noreferrer" aria-label="Pinterest">
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div className="footer-contact">
                    ...
                    <ul>
                      <li>
                        ...
                        <a href="mailto:hello@evol.com">hello@evol.com</a>
                      </li>
                      <li>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="footer-model-card">
                  <div className="footer-model-image">
                    <img 
                      src={modelImage} 
                      alt="EVOL Brand Model - Designed for effortless everyday elegance"
                      loading="lazy"
                    />
                  </div>
                  <p className="footer-model-mission">Designed for effortless everyday elegance</p>
                </div>
              </div>
              ...
              <div className="footer-newsletter">
                <div className="newsletter-content">
                  ...
                  <p>Subscribe for exclusive offers, new arrivals & wellness tips.</p>
                </div>
                <NewsletterSignup />
              </div>
